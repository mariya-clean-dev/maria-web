    ...
    <div className={styles.legalWrapper}>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <h3 className={styles.sectionTitle} style={{ fontSize: '18px', borderBottom: 'none' }}>A. Information You Provide to Us Directly:</h3>
          ...
          <h3 className={styles.sectionTitle} style={{ fontSize: '18px', borderBottom: 'none' }}>B. Operational Information We Collect Automatically:</h3>
          <p className={styles.text}>
          ...
          <h3 className={styles.sectionTitle} style={{ fontSize: '18px', borderBottom: 'none' }}>C. Information We Collect from Third Parties:</h3>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li>To <strong>Provide and Fulfill Services:</strong> To process your cleaning service bookings, manage your account, and deliver the requested services.</li>
            <li>For <strong>Communication:</strong> To send you booking confirmations, service reminders, updates, and to respond to your inquiries via email or phone.</li>
            <li>For <strong>Security and Fraud Prevention:</strong> To detect, prevent, and address fraudulent or unauthorized activity and to protect the security and integrity of our Site and our users.</li>
            <li>For <strong>Legal Compliance:</strong> To comply with applicable laws, regulations, legal processes, or governmental requests.</li>
          </ul>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            Clean Maria does not use cookies for analytics, advertising, or tracking purposes. We only use <strong>strictly necessary cookies</strong> (also known as essential or functional cookies) that are absolutely required for the core functionality of our cleaning service booking site.
          </p>
          <p className={styles.text}>
            <strong>How We Use Them:</strong>
          </p>
          <ul className={styles.list}>
            <li><strong>Essential functionality:</strong> To enable features like remembering your service selections during a booking session, maintaining your login session, and ensuring the secure processing of your service requests.</li>
          </ul>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>8. Your Data Protection Rights</h2>
          <p className={styles.text}>
          ...
          <ul className={styles.list}>
            <li><strong>Right to Access:</strong> You have the right to request copies of your personal data we hold.</li>
            ...
            <li><strong>Right to Object to Processing:</strong> You have the right to object to our processing of your personal data under certain conditions (e.g., if we were to engage in direct marketing you didn't consent to).</li>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>9. International Data Transfers (If Applicable)</h2>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li><strong>By visiting this page on our website:</strong> <a href="https://cleanmaria.com/" style={{ color: '#17A5C6', textDecoration: 'underline' }}>https://cleanmaria.com/</a></li>
          </ul>
        </section>
        ...
        <div className={styles.redirectCard}>
          <div className={styles.redirectText}>
            ...
            <span>Read about the rules and guidelines for using our services.</span>
          </div>
          <Link href="/terms" className={styles.redirectButton}>
